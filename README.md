...
**Com relação às aulas do período de 16 a 27 de março de 2020, serão indicados videos com os conteúdos correspondentes. As informações referentes a essas aulas (videos, slides e questões correspondentes) estão indicadas em**

https://github.com/DiogoCaetanoGarcia/Sistemas_Embarcados/blob/master/Aulas/README.md

**As questões deverão ser respondidas até o dia 23 de março de 2020.**

...
int main(void)
{
	...
	printf("\n   Dados ");
	if(mode & SPI_CPHA) printf("capturados na primeira borda do clock\n      e enviados na segunda borda");
	else printf("enviados na primeira borda do clock\n      e capturados na segunda borda");

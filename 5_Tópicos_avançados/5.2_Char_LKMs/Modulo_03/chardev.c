...
// que sempre retorna um caracter '1' ou
// o último caracter escrito nele
...
static char last_char = '1';   // Variável que guarda o último caracter escrito
			   ...
			   loff_t * offset)
{
	...
	put_user(last_char, buffer);         // Caso contrario, retorne um carcater 1
	Device_Counter++;
	return 1;
}
